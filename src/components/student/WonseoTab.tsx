    ...
    <div className="space-y-6">
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-indigo-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <h3 className="text-lg font-black tracking-tight text-slate-900">나의 수시 카드</h3>
          <span className="bg-indigo-50 border border-indigo-200 text-indigo-600 text-[11px] font-bold px-2.5 py-0.5 rounded-full">
            {cards.length}개 등록됨
          </span>
        </div>
        <button
          onClick={openCreate}
          className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl text-xs font-bold transition shadow-xs flex items-center gap-2 shrink-0"
        >
